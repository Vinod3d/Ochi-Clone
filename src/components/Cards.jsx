...
const Cards = () => {
  return (
    <div className="w-full p-10 lg:p-20 h-screen bg-zinc-100 flex max-lg:flex-col gap-5 items-center">
        <div className="cardcontainer h-[80vw] lg:h-[30vw] w-full lg:w-1/2 rounded-xl overflow-hidden">
        ...
        <div className="cardcontainer flex gap-5 h-[80vw] lg:h-[30vw] w-full lg:w-1/2">
